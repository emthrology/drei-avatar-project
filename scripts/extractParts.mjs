...
const JOBS = [
  ...
  {
    src: 'male1/parts/male_white_shirt.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'male1/Tops_white_shirt.glb',
    vrm: false,
  },
  {
    src: 'male1/parts/male_top_basic.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'male1/Tops_basic.glb',
    vrm: false,
  },
  {
    src: 'male1/parts/male_top_hawaian.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'male1/Tops_hawaian.glb',
    vrm: false,
  },
  // 하의 변형(Bottoms_01_CLOTH / 흰 바지는 Onepiece_00_CLOTH 2프리미티브)
  {
    src: 'male1/parts/male_scotch_pants.vrm',
    mesh: 'Body',
    keepMaterial: 'Bottoms_01_CLOTH',
    out: 'male1/Bottoms_scotch_pants.glb',
    vrm: false,
  },
  {
    src: 'male1/parts/male_bottom_jean.vrm',
    mesh: 'Body',
    keepMaterial: 'Bottoms_01_CLOTH',
    out: 'male1/Bottoms_jean.glb',
    vrm: false,
  },
  {
    src: 'male1/parts/male_bottom_white_pants.vrm',
    mesh: 'Body',
    keepMaterial: 'Onepiece_00_CLOTH',
    out: 'male1/Bottoms_white_pants.glb',
    vrm: false,
  },
  {
    src: 'male_sample.vrm',
  ...
  {
    src: 'male_eye_sample.vrm',
    mesh: 'Face',
    out: 'male1/Face_eyesample.vrm',
    vrm: true,
    nsBones: 'FaceEye',
  },
  {
    src: 'male1/parts/male_face_2.vrm',
    mesh: 'Face',
    out: 'male1/Face_2.vrm',
    vrm: true,
    nsBones: 'FaceEye',
  },
  // 상의 추가(top_2 = Tops_01_CLOTH 1프리미티브 / top_3 = Tops_01_CLOTH_01·_02 2프리미티브, 둘 다 'Tops_01_CLOTH' 포함)
  {
    src: 'male1/parts/male_top_2.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'male1/Tops_2.glb',
    vrm: false,
  },
  {
    src: 'male1/parts/male_top_3.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'male1/Tops_3.glb',
    vrm: false,
  },
  // 헤어 추가(female 동형: 앞머리 Hair001 + 뒷머리 Body/HairBack 2메시 + 스프링 보존, J_Sec_*Hair 네임스페이스)
  {
    src: 'male1/parts/male_hair_2.vrm',
    meshes: [{ mesh: 'Hair001' }, { mesh: 'Body', keepMaterial: 'HairBack' }],
    out: 'male1/Hair_2.vrm',
    vrm: true,
    springKeep: 'Hair',
    nsBones: '^J_Sec_.*Hair',
  },
  {
    src: 'male1/parts/male_hair_3.vrm',
    meshes: [{ mesh: 'Hair001' }, { mesh: 'Body', keepMaterial: 'HairBack' }],
    out: 'male1/Hair_3.vrm',
    vrm: true,
    springKeep: 'Hair',
    nsBones: '^J_Sec_.*Hair',
  },
  ...
  {
    src: 'female1/parts/female_top_1.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'female1/Tops_1.glb',
    vrm: false,
  },
  {
    src: 'female1/parts/female_top_2.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'female1/Tops_2.glb',
    vrm: false,
  },
  {
    src: 'female1/parts/female_top_3.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'female1/Tops_3.glb',
    vrm: false,
  },
  {
    src: 'female1/parts/female_top_4.vrm',
    mesh: 'Body',
    keepMaterial: 'Tops_01_CLOTH',
    out: 'female1/Tops_4.glb',
    vrm: false,
  },
  // 하의(Bottoms_01_CLOTH)
  {
    src: 'female1/parts/female_bottom_1.vrm',
    mesh: 'Body',
    keepMaterial: 'Bottoms_01_CLOTH',
    out: 'female1/Bottoms_1.glb',
    vrm: false,
  },
  {
    src: 'female1/parts/female_bottom_2.vrm',
    mesh: 'Body',
    keepMaterial: 'Bottoms_01_CLOTH',
    out: 'female1/Bottoms_2.glb',
    vrm: false,
  },
  {
    src: 'female1/parts/female_bottom_3.vrm',
    mesh: 'Body',
    keepMaterial: 'Bottoms_01_CLOTH',
    out: 'female1/Bottoms_3.glb',
    vrm: false,
  },
  // 얼굴(B트랙, male1 동형 — Face 메시·57모프·눈 본 네임스페이스). face_1 = 베이스 얼굴이라 제외.
  {
    src: 'female1/parts/female_face_2.vrm',
    mesh: 'Face',
    out: 'female1/Face_2.vrm',
    vrm: true,
    nsBones: 'FaceEye',
  },
  {
    src: 'female1/parts/female_face_3.vrm',
    mesh: 'Face',
    out: 'female1/Face_3.vrm',
    vrm: true,
    nsBones: 'FaceEye',
  },
  {
    src: 'female1/parts/female_face_4.vrm',
    mesh: 'Face',
    out: 'female1/Face_4.vrm',
    vrm: true,
    nsBones: 'FaceEye',
  },
  ...
  {
    src: 'female1/parts/female_hair_1.vrm',
    meshes: [{ mesh: 'Hair001' }, { mesh: 'Body', keepMaterial: 'HairBack' }],
    out: 'female1/Hair_1.vrm',
    vrm: true,
    springKeep: 'Hair',
    nsBones: '^J_Sec_.*Hair',
  },
  {
    src: 'female1/parts/female_hair_2.vrm',
    meshes: [{ mesh: 'Hair001' }, { mesh: 'Body', keepMaterial: 'HairBack' }],
    out: 'female1/Hair_2.vrm',
    vrm: true,
    springKeep: 'Hair',
    nsBones: '^J_Sec_.*Hair',
  },
  {
    src: 'female1/parts/female_hair_3.vrm',
    meshes: [{ mesh: 'Hair001' }, { mesh: 'Body', keepMaterial: 'HairBack' }],
    out: 'female1/Hair_3.vrm',
    vrm: true,
    springKeep: 'Hair',
    nsBones: '^J_Sec_.*Hair',
  },
  {
    src: 'female1/parts/female_hair_4.vrm',
    meshes: [{ mesh: 'Hair001' }, { mesh: 'Body', keepMaterial: 'HairBack' }],
    out: 'female1/Hair_4.vrm',
    vrm: true,
    springKeep: 'Hair',
    nsBones: '^J_Sec_.*Hair',
  },
...
function packGLB(json, bin) {
  ...
  let p = 0;
  out.writeUInt32LE(MAGIC, p);
  p += 4;
  out.writeUInt32LE(2, p);
  p += 4;
  out.writeUInt32LE(total, p);
  p += 4;
  out.writeUInt32LE(enc.length + jsonPad, p);
  p += 4;
  out.writeUInt32LE(JSON_CHUNK, p);
  p += 4;
...
function remapTexInObject(obj, texMap) {
  if (Array.isArray(obj)) {
    obj.forEach((v) => remapTexInObject(v, texMap));
    return;
  }
  if (obj && typeof obj === 'object') {
    for (const [k, v] of Object.entries(obj)) {
      if (k === 'index' && typeof v === 'number' && texMap.has(v))
        obj.index = texMap.get(v);
...
function pruneVrm(path) {
  ...
  const rendered = new Set(
    g.nodes.filter((n) => n.mesh !== undefined).map((n) => n.mesh),
  );
  const keptMat = new Set();
  g.meshes.forEach((m, mi) => {
    if (rendered.has(mi))
      m.primitives.forEach((p) => {
        if (p.material != null) keptMat.add(p.material);
      });
  });
  // 2) 보존 머티리얼이 참조하는 텍스처(모든 .index 수집 — over-keep 은 안전)
  const keptTex = new Set();
  for (const mi of keptMat) {
    JSON.stringify(g.materials[mi]).replace(/"index":\s*(\d+)/g, (_, n) => {
      keptTex.add(+n);
      return _;
    });
  }
  ...
  for (const grp of [pre?.preset, pre?.custom]) {
    for (const v of Object.values(grp || {})) {
      for (const b of [
        ...(v.materialColorBinds || []),
        ...(v.textureTransformBinds || []),
      ]) {
        keptMat.add(b.material);
        exprMatBinds.push(b);
      }
    }
  }
  ...
  for (const ti of keptTex) {
    const t = g.textures?.[ti];
    if (t && t.source != null) keptImg.add(t.source);
  }
  ...
  g.accessors.forEach((a) => {
    ...
    if (a.sparse) {
      keptBV.add(a.sparse.indices.bufferView);
      keptBV.add(a.sparse.values.bufferView);
    }
  });
  for (const ii of keptImg) {
    const im = g.images?.[ii];
    if (im && im.bufferView != null) keptBV.add(im.bufferView);
  }
  ...
  g.materials.forEach((m, i) => {
    if (keptMat.has(i)) {
      remapTexInObject(m, texMap);
      matMap.set(i, newMaterials.length);
      newMaterials.push(m);
    }
  });
  ...
  g.meshes.forEach((m) =>
    m.primitives.forEach((p) => {
      if (p.material != null) {
        const nm = matMap.get(p.material);
        if (nm != null) p.material = nm;
        else delete p.material;
      }
    }),
  );
  if (thumb != null && g.extensions?.VRMC_vrm?.meta)
    g.extensions.VRMC_vrm.meta.thumbnailImage = imgMap.get(thumb);
...
function runJob(job) {
  ...
  const targets = job.meshes ?? [
    { mesh: job.mesh, keepMaterial: job.keepMaterial },
  ];
  const keepIdx = new Set();
  const outName = job.out
    .split('/')
    .pop()
    .replace(/\.\w+$/, '');
  targets.forEach((t, ti) => {
    ...
    if (t.keepMaterial) {
      ...
      if (!kept.length)
        throw new Error(
          `${job.src}: material "${t.keepMaterial}" 없음 (mesh ${t.mesh})`,
        );
  ...
  if (job.vrm) {
    ...
    if (sb?.springs && job.springKeep) {
      sb.springs = sb.springs.filter((s) =>
        s.joints?.some((j) =>
          (g.nodes[j.node]?.name ?? '').includes(job.springKeep),
        ),
      );
    }
...
for (const job of JOBS) {
  ...
  if (!job.vrm)
    await pruneGlb(`${DIR}/${job.out}`); // GLB: gltf-transform prune
  ...
  const saved = (
    (before - fs.statSync(`${DIR}/${job.out}`).size) /
    1024 /
    1024
  ).toFixed(1);
  const springs = re.json.extensions?.VRMC_springBone?.springs?.length;
  const renderedMeshes = new Set(rn.map((n) => n.mesh));
  const prims = [...renderedMeshes].reduce(
    (s, mi) => s + re.json.meshes[mi].primitives.length,
    0,
  );
  // 무결성 가드: 보존 머티리얼의 텍스처/이미지 참조가 범위 내인지
  let dangling = 0;
  re.json.materials?.forEach((m) =>
    JSON.stringify(m).replace(/"index":\s*(\d+)/g, (_, n) => {
      if (+n >= (re.json.textures?.length ?? 0)) dangling++;
      return _;
    }),
  );
  re.json.textures?.forEach((t) => {
    if (t.source != null && t.source >= (re.json.images?.length ?? 0))
      dangling++;
  });
  const morphs = job.vrm
    ? re.json.meshes[[...renderedMeshes][0]]?.primitives[0]?.targets?.length
    : null;
  console.log(
