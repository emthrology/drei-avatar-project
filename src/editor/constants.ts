...
export const CHARACTERS: CharacterDef[] = [
  {
    ...
    catalog: [
        ...
        variants: [
          {
            id: 'face-eyesample',
            label: '얼굴 1',
            url: '/avatars/male1/Face_eyesample.vrm',
            thumb: thumb('face-eyesample'),
          },
          {
            id: 'face-2',
            label: '얼굴 2',
            url: '/avatars/male1/Face_2.vrm',
            thumb: thumb('face-2'),
          },
        ],
      },
        ...
        variants: [
          {
            id: 'hair-sample',
            label: '헤어 1',
            url: '/avatars/Hair_sample.vrm',
            thumb: thumb('hair-sample'),
          },
          {
            id: 'hair-2',
            label: '헤어 2',
            url: '/avatars/male1/Hair_2.vrm',
            thumb: thumb('hair-2'),
          },
          {
            id: 'hair-3',
            label: '헤어 3',
            url: '/avatars/male1/Hair_3.vrm',
            thumb: thumb('hair-3'),
          },
        ],
      },
        ...
        variants: [
          {
            id: 'tops-white-shirt',
            label: '상의 1',
            url: '/avatars/male1/Tops_white_shirt.glb',
            thumb: thumb('tops-white-shirt'),
          },
          {
            id: 'tops-basic',
            label: '상의 2',
            url: '/avatars/male1/Tops_basic.glb',
            thumb: thumb('tops-basic'),
          },
          {
            id: 'tops-hawaian',
            label: '상의 3',
            url: '/avatars/male1/Tops_hawaian.glb',
            thumb: thumb('tops-hawaian'),
          },
          {
            id: 'tops-2',
            label: '상의 4',
            url: '/avatars/male1/Tops_2.glb',
            thumb: thumb('tops-2'),
          },
          {
            id: 'tops-3',
            label: '상의 5',
            url: '/avatars/male1/Tops_3.glb',
            thumb: thumb('tops-3'),
          },
        ],
      },
      {
        ...
        variants: [
          {
            id: 'bottoms-scotch-pants',
            label: '하의 1',
            url: '/avatars/male1/Bottoms_scotch_pants.glb',
            thumb: thumb('bottoms-scotch-pants'),
          },
          {
            id: 'bottoms-jean',
            label: '하의 2',
            url: '/avatars/male1/Bottoms_jean.glb',
            thumb: thumb('bottoms-jean'),
          },
          {
            id: 'bottoms-white-pants',
            label: '하의 3',
            url: '/avatars/male1/Bottoms_white_pants.glb',
            thumb: thumb('bottoms-white-pants'),
          },
        ],
      },
    ],
  },
  {
    id: 'female1',
    label: '여자1',
    baseUrl: '/avatars/female1/female_base.vrm',
    catalog: [
      {
        id: 'face',
        label: 'Face',
        ...
        variants: [
          {
            id: 'f1-face-2',
            label: '얼굴 2',
            url: '/avatars/female1/Face_2.vrm',
            thumb: thumb('f1-face-2'),
          },
          {
            id: 'f1-face-3',
            label: '얼굴 3',
            url: '/avatars/female1/Face_3.vrm',
            thumb: thumb('f1-face-3'),
          },
          {
            id: 'f1-face-4',
            label: '얼굴 4',
            url: '/avatars/female1/Face_4.vrm',
            thumb: thumb('f1-face-4'),
          },
        ],
      },
      {
        ...
        variants: [
          {
            id: 'f1-hair-1',
            label: '헤어 1',
            url: '/avatars/female1/Hair_1.vrm',
            thumb: thumb('f1-hair-1'),
          },
          {
            id: 'f1-hair-2',
            label: '헤어 2',
            url: '/avatars/female1/Hair_2.vrm',
            thumb: thumb('f1-hair-2'),
          },
          {
            id: 'f1-hair-3',
            label: '헤어 3',
            url: '/avatars/female1/Hair_3.vrm',
            thumb: thumb('f1-hair-3'),
          },
          {
            id: 'f1-hair-4',
            label: '헤어 4',
            url: '/avatars/female1/Hair_4.vrm',
            thumb: thumb('f1-hair-4'),
          },
        ],
      },
      {
        ...
        variants: [
          {
            id: 'f1-tops-1',
            label: '상의 1',
            url: '/avatars/female1/Tops_1.glb',
            thumb: thumb('f1-tops-1'),
          },
          {
            id: 'f1-tops-2',
            label: '상의 2',
            url: '/avatars/female1/Tops_2.glb',
            thumb: thumb('f1-tops-2'),
          },
          // TODO 시각 검토: top_3 = 타이 제외본 / top_4 = Onepiece·Shoes 혼합본(Tops_01_CLOTH만 남김)
          {
            id: 'f1-tops-3',
            label: '상의 3',
            url: '/avatars/female1/Tops_3.glb',
            thumb: thumb('f1-tops-3'),
          },
          {
            id: 'f1-tops-4',
            label: '상의 4',
            url: '/avatars/female1/Tops_4.glb',
            thumb: thumb('f1-tops-4'),
          },
        ],
      },
      {
        ...
        variants: [
          {
            id: 'f1-bottoms-1',
            label: '하의 1',
            url: '/avatars/female1/Bottoms_1.glb',
            thumb: thumb('f1-bottoms-1'),
          },
          {
            id: 'f1-bottoms-2',
            label: '하의 2',
            url: '/avatars/female1/Bottoms_2.glb',
            thumb: thumb('f1-bottoms-2'),
          },
          {
            id: 'f1-bottoms-3',
            label: '하의 3',
            url: '/avatars/female1/Bottoms_3.glb',
            thumb: thumb('f1-bottoms-3'),
          },
        ],
      },
    ],
...
export const VARIANTS_BY_ID: Map<string, ResolvedVariant> = new Map(
  CHARACTERS.flatMap((ch) =>
    ch.catalog.flatMap((c) =>
      c.variants.map(
        (variant) =>
          [variant.id, { categoryId: c.id, kind: c.kind, variant }] as const,
      ),
    ),
  ),
);
...
export const defaultSelection = (catalog: PartCategoryDef[]): Selection =>
  Object.fromEntries(
    catalog.map((c) => [c.id, c.variants[0]?.id ?? null]),
  ) as Selection;
