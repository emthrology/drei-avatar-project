...
export type GameEventType =
  'player_die' | 'level_clear' | 'near_miss' | 'jump' | 'start';
...
export const REACTIONS: Record<Lang, Record<GameEventType, Reaction[]>> = {
  ...
  en: {
    ...
    near_miss: [{ text: 'That was close!' }, { text: 'Whoa, barely made it!' }],
    jump: [{ text: 'Jump!' }, { text: 'Nice jump!' }],
    start: [{ text: "Let's go!" }, { text: 'Good luck!' }],
  },
};
...
export const TTS_CONFIG: Record<
  Lang,
  Record<Gender, { languageCode: string; name: string }>
> = {
  ko: {
